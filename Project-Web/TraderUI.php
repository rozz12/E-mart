<?php
    ...
    if (!isset($_SESSION['Trader_id'])) {
        ...
        if (!isset($_GET['shop_name'])) {
            ...
            $trd_prod_qry =  'SELECT Product_id, Product_name, Product_image, Description, Allergy_information, Initial_price, quantity  FROM product p RIGHT JOIN shop s ON p.shop_id = s.shop_id INNER JOIN Trader t ON s.trader_id = t.trader_id and t.trader_id = :trader_id ';
             $trd_parse = oci_parse($conn, $trd_prod_qry);
            oci_bind_by_name($trd_parse, ':trader_id', $trader_id);
        }
        //select only products in selected shop 
        else{
            $trd_prod_qry = ' SELECT Product_id, Product_name, Product_image, Description, Allergy_information, Initial_price, quantity  FROM product p,shop s WHERE p.shop_id = s.shop_id AND s.shop_name =\''.$_GET['shop_name'].'\'';
             $trd_parse = oci_parse($conn, $trd_prod_qry);
        }
        ...
        <div class="container border border-dark p-2">
            ...
            <div class="row pb-3">
                <div class="col-md-4 d-flex justify-content-evenly col-sm-12 col-xs-12">
                    <button type="button" class="btn btn-primary mt-2 product_button " onclick="addshop()">Add Shop</button>
                </div>
                <div class="col-md-4 d-flex justify-content-evenly col-sm-12 col-xs-12">
                ...
                <div class="col-md-3 justify-content-center py-2 px-2">
                    ...
                    <div class="card flex-column px-2 py-2 card_product">
                        <div class="">
                            ...
                            <p class="fs-5">In Stock: <?php echo $prods['QUANTITY']?></p>
