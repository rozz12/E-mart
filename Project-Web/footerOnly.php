		...
		<div class="row">
			...
			<div class="col-lg-3 col-md-6 col-sm-12 col-xs-12 pt-3">
				...
				<ul class="nav flex-column">
					...
					<p class="fs-5 border-top border-2 border-dark">
						<a href="https://www.seb.ee/files/tingimused/interneti_kaupmehelepingu_tingimused_eng.pdf" class="text-decoration-none">Terms and Conditions</a>
					</p>
					<p class="fs-5 border-top border-2 border-dark">
						<a href="mailto:ashimshrestha125@gmail.com" class="text-decoration-none">Write a mail</a>
					</p>
				</ul>
			</div>
			<div
