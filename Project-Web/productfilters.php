...
include('../php/connection.php');
	...
	elseif (isset($_POST['Price_range'])||isset($_POST['Rating'])||isset($_POST['Discount'])) {
		...
		elseif (isset($_POST['Price_range'])) {
				...
				elseif($sorttype == 'DISCOUNT_PERCENTAGE' && $sortorder == 'Asc'){
					$sql = 'SELECT Product_name,Product_Image,Initial_price,Selling_price,Product_Rating FROM Product  WHERE  Selling_Price<=:price_range ORDER BY DISCOUNT_PERCENTAGE asc';
				}
				elseif($sorttype == 'PRODUCT_NAME' && $sortorder == 'Asc'){
				...
				elseif($sorttype == 'DISCOUNT_PERCENTAGE' && $sortorder == 'Desc'){
					$sql = 'SELECT Product_name,Product_Image,Initial_price,Selling_price,Product_Rating FROM Product  WHERE  Selling_Price<=:price_range ORDER BY DISCOUNT_PERCENTAGE desc';
				}
				else{
