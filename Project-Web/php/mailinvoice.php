...
date_default_timezone_set('Asia/Kathmandu');
	...
	$emailqry = "SELECT email FROM Customer WHERE Customer_id = ".$_SESSION['Customer_id'];
...
$sql = 'SELECT Firstname, Surname, Contact_no FROM Customer WHERE Customer_id = :customer_id';
...
oci_bind_by_name($o_parse, ':customer_id', $_SESSION['Customer_id']);
oci_execute($o_parse);
...
$pdf->Cell(8,5,$_SESSION['Customer_id'],0,1);//end of line
...
function sendmail($pdf,$usermail){
	...
	try {
	    ...
	    echo "<html>
    			<body>
    			<h1 style='color:green;text-align:center;'>Please check your mail for a copy of the invoice.</h1> 
    			<p style='color:green;text-align:center;'>You will be redirected in 5 seconds</p>
    			<script>
