					...
					if (!$r) {
						...
						function sendmail($usermail){
							...
							try {
							    ...
							    $mail->Body    = "<b>Please verify your cleckhuddersfax E-Mart account by clicking this link</b><a href = 'http://localhost/Project-web/verify_user.php?vkey=$vkey'>Register Account</a>";
