					...
					if (!$r) {
						...
						function sendmail($email,$vkey,$user_type){
							...
							try {
							    ...
							    $mail->Body    = "<b>Please verify your cleckhuddersfax E-Mart account by clicking this link </b><a href = 'http://localhost/Project-web/verify_user.php?vkey=$vkey&user=$user_type'>Register Account</a>
