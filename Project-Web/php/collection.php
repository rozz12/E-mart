...
if(strtotime($weekday)==strtotime("Saturday") OR strtotime($weekday)==strtotime("Sunday") OR strtotime($weekday)==strtotime("Monday") OR strtotime($weekday)==strtotime("Tuesday")){                                  
      echo'<form action="php/collection.php" method="POST">
                 <div class="row pb-5">
                 <div class="col-md-5">
              ...
              echo'</select>
                    ...
                    <select class="form-select" name="collection_day">';
                     if(strtotime($weekday)==strtotime("Saturday")){        
			        	$sql2 = "Select * from collectionslot where slotid>9";    
			      	}
			      	else{
			        	$sql2 = "Select * from collectionslot where slotid<10";        
			      	}   
                	$sql2 = "Select collectiontime from collectionslot where slotid>6 and slotid<16";
    ...
    if(strtotime($hour) < strtotime("10:00:00")){              
      echo'<form action="php/collection.php" method="POST">
              ...
              echo'</select>
                    ...
                    <div class="col-md-7">
                    <select class="form-select" name="collection_day">';
                $sql2 = "Select collectiontime from collectionslot where slotid<10";
                $res2 = oci_parse($conn, $sql2);
                oci_execute($res2);
               while($data2=oci_fetch_assoc($res2)){          
               		if($data2['NUMBER_OF_ORDERS']<20){       
        ...
        echo'<form action="php/collection.php" method="POST">
              ...
              echo'</select>
                    ...
                    <div class="col-md-7">
                    <select class="form-select" name="collection_day">';
                $sql2 = "Select collectiontime from collectionslot where slotid!=1 and slotid<10";
                $res2 = oci_parse($conn, $sql2);
                oci_execute($res2);
               while($data2=oci_fetch_assoc($res2)){          
               		if($data2['NUMBER_OF_ORDERS']<20){       
        ...
        echo'<form action="php/collection.php" method="POST">
              ...
              echo'</select>
                    ...
                    <div class="col-md-7">
                    <select class="form-select" name="collection_day">';
                $sql2 = "Select collectiontime from collectionslot where slotid>2 and slotid<10";
                $res2 = oci_parse($conn, $sql2);
                oci_execute($res2);
               while($data2=oci_fetch_assoc($res2)){          
               		if($data2['NUMBER_OF_ORDERS']<20){       
       ...
       echo'<form action="php/collection.php" method="POST">
              ...
              echo'</select>
                    ...
                    <div class="col-md-7">
                    <select class="form-select" name="collection_day">';
                $sql2 = "Select collectiontime from collectionslot where slotid>3 and slotid<13";
                $res2 = oci_parse($conn, $sql2);
                oci_execute($res2);
               while($data2=oci_fetch_assoc($res2)){          
               		if($data2['NUMBER_OF_ORDERS']<20){       
    ...
    if(strtotime($hour) < strtotime("10:00:00")){
       echo'<form action="php/collection.php" method="POST">
        ...
        echo'<form action="php/collection.php" method="POST">
              ...
              echo'</select>
                    ...
                    <div class="col-md-7">
                    <select class="form-select" name="collection_day">';
                $sql2 = "Select collectiontime from collectionslot where slotid>4 and slotid<13";
                $res2 = oci_parse($conn, $sql2);
                oci_execute($res2);
               while($data2=oci_fetch_assoc($res2)){          
               		if($data2['NUMBER_OF_ORDERS']<20){       
      ...
      echo'<form action="php/collection.php" method="POST">
              ...
              echo'</select>
                    ...
                    <div class="col-md-7">
                    <select class="form-select" name="collection_day">';
                $sql2 = "Select collectiontime from collectionslot where slotid>5 and slotid<13";
                $res2 = oci_parse($conn, $sql2);
                oci_execute($res2);
               while($data2=oci_fetch_assoc($res2)){          
               		if($data2['NUMBER_OF_ORDERS']<20){       
    ...
    if(strtotime($hour) < strtotime("10:00:00")){
       ...
       echo'<form action="php/collection.php" method="POST">
              ...
              echo'</select>
                    ...
                    <div class="col-md-7">
                    <select class="form-select" name="collection_day">';
                $sql2 = "Select collectiontime from collectionslot where slotid>7 and slotid<16";
                $res2 = oci_parse($conn, $sql2);
                oci_execute($res2);
               while($data2=oci_fetch_assoc($res2)){          
               		if($data2['NUMBER_OF_ORDERS']<20){       
       ...
       echo'<form action="php/collection.php" method="POST">
              ...
              echo'</select>
                    ...
                    <div class="col-md-7">
                    <select class="form-select" name="collection_day">';
                $sql2 = "Select collectiontime from collectionslot where slotid>8 and slotid<16";
                $res2 = oci_parse($conn, $sql2);
                oci_execute($res2);
               while($data2=oci_fetch_assoc($res2)){          
               		if($data2['NUMBER_OF_ORDERS']<20){       
        ...
        echo'<form action="php/collection.php" method="POST">
              ...
              echo'</select>
                    ...
                    <div class="col-md-7">
                    <select class="form-select" name="collection_day">';
                $sql2 = "Select collectiontime from collectionslot where slotid>9";
                $res2 = oci_parse($conn, $sql2);
                oci_execute($res2);
               while($data2=oci_fetch_assoc($res2)){          
               		if($data2['NUMBER_OF_ORDERS']<20){       
