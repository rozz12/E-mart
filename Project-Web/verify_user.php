...
if(isset($_GET['vkey']))
{
    $verifykey = $_GET['vkey'];
    if ($_GET['user'] == 'Trader') {
      $sql = "Update Trader SET STATUS = 1 where VERIFY_KEY='$verifykey'";
    }
    else{
      $sql = "Update Customer SET STATUS = 1 where VERIFY_KEY='$verifykey'";
    }
        ...
        <div class="modal-dialog">    
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <p>Your account is successfully verified. Thank you for choosing us.<br/> You will be now redirected to login page</p>
            </div>
