    ...
    <div class="container-fluid border border-1 border-dark p-4 mb-3">
        ...
        <div class="row">
            <?php
                ...
                $cat_qry = 'SELECT product_id, product_name, initial_price, description, PRODUCT_RATING FROM product p , shop s WHERE p.shop_id = s.shop_id AND category(shoptype_id) = :category ';
            ...
            <div class="col-md-4 justify-content-center py-2 px-2">
                <a href="productDetails.php?product_id=<?php echo $ctgrize_prod['PRODUCT_ID']?>" class="text-decoration-none">
                    <div class="card flex-column px-2 py-2 card_product">
                        <div class="">
                            <img src="images/<?php echo $ctgrize_prod['PRODUCT_IMAGE']?>" class="img-fluid" alt="product">
                        </div>
                        <div class="">
                        ...
                        <div class="">
                            <p class="fs-5 text-dark">Rating: <?php echo $ctgrize_prod['PRODUCT_RATING']?></p>
                        </div>
                        <div class="">
