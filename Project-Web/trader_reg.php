...
<body>
	<article style="width: 100%;">
		...
		<div class="form-content">
			<img src="images/C.png" style="width: 300px ; height: 200px;">
			<h2>Trader Registration Form</h2>
			 <?php
				...
				if (strpos($fullurl, "register=invalidemail")==true) {
					echo "<h3 class='error'>Please fill in a valid email adress</h3>";
				}
				if (strpos($fullurl, "register=invalidpswd")==true) {
					echo "<h3 class='error'>The password does not match required criterias</h3>";
				}
        	?>
			<form action="php/register_trader.php" method="POST">
				<div class="form-group">
					<div class="form-inline form-group">
						<label >Business Owner</label>

						<!-- uses value and php to persist the entered value in the form-->
						<input type="text" name="firstname" class="form-control mr-sm-4" value="<?php if(isset($_POST['firstname'])){
					...
					<div class="form-inline form-group">
						...
						<input type="text" name="area_code" class="form-control  mr-sm-4" value="<?php if(isset($_POST['area_code'])){
					...
					<div class="form-inline form-group">
						...
						<select name="Shop_type" class="form-control">
							<option value="Bakery"  <?php if(isset($_POST["shop_type"])&&$_POST['shop_type']=='Bakery'){
								echo 'selected';
								}?>> Bakery</option>
							 <option value="Delicatessen" <?php if(isset($_POST['shop_type'])&&$_POST['shop_type']=='Delicatessen'){
							echo 'selected';
						} ?> >Delicatessen</option>
							 <option value="FishMonger" <?php if(isset($_POST['shop_type'])&&$_POST['shop_type']=='FishMonger'){
							echo 'selected';
						} ?> >FishMonger</option>
							 <option value="Butcher" <?php if(isset($_POST['shop_type'])&&$_POST['shop_type']=='Butcher'){
							echo 'selected';
						} ?> >Butcher</option>
							 <option value="Grocery" <?php if(isset($_POST['shop_type'])&&$_POST['shop_type']=='Grocery'){
							echo 'selected';
						} ?> >Grocery</option>
						</select>
					</div>
					...
					<div class="form-inline form-group">
						...
						<input type="password" name="psd" id="confupwd" class="form-control" onfocusout="pwdcheck()" />
						<div class="input-group-append"><i class="far fa-eye btn" id = "togglePassword1"></i></div><label id="pmatch" style="color: red; visibility: hidden;"></label>					
					</div>
					<div class="checkboxes">
						<div class="custom-control custom-checkbox form-group">
	    					<input type="checkbox" class="custom-control-input" id="Agreement" name="terms_agree">
	    					<label class="custom-control-label" for="Agreement">Keep me signed in<br> By clicking on <a href = #><b>Register</b></a>, you acknowledge to have read our <a href=#><b>Terms & Conditions</b></a> </label>
	  					</div>
	  					<br>
						<div class="custom-control custom-checkbox form-group">
							<input type="checkbox" class="custom-control-input" id="Email_new" name="new_item_email">
							<label class="custom-control-label" for="Email_new">Email me about new items/newsletters/offers and more</label>
						</div>
					</div>
					<div class="d-flex flex-column align-content-around form-inline form-group">
		 				<input type="Submit" name="Register" value="Register" class="btn-lg btn-primary mb-1 flex-fill" />
		 					<h5>OR</h5>
						<input type="Submit" name="Register_as_customer" value="Register As Customer" class="btn btn-secondary mb-1"  />
